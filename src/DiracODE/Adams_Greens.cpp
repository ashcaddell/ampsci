...
void GreenSolution(DiracSpinor &Fa, const DiracSpinor &Finf,
  ...
  NumCalc::additivePIntegral<ztr>(Fa.f, Finf.f, Fzero.f, Sr.f, gr, Finf.max_pt());
  NumCalc::additivePIntegral<ztr>(Fa.f, Finf.f, Fzero.g, Sr.g, gr, Finf.max_pt());
  NumCalc::additivePIntegral<rti>(Fa.f, Fzero.f, Finf.f, Sr.f, gr, Finf.max_pt());
  NumCalc::additivePIntegral<rti>(Fa.f, Fzero.f, Finf.g, Sr.g, gr, Finf.max_pt());
  NumCalc::additivePIntegral<ztr>(Fa.g, Finf.g, Fzero.f, Sr.f, gr, Finf.max_pt());
  NumCalc::additivePIntegral<ztr>(Fa.g, Finf.g, Fzero.g, Sr.g, gr, Finf.max_pt());
  NumCalc::additivePIntegral<rti>(Fa.g, Fzero.g, Finf.f, Sr.f, gr, Finf.max_pt());
  NumCalc::additivePIntegral<rti>(Fa.g, Fzero.g, Finf.g, Sr.g, gr, Finf.max_pt());
  Fa *= (alpha / w2);
